var stringEN = {
	...
	text:[
		...
		},
		{
			...
			info:"The Service collects information from you in two ways: directly from your input and automatically through the Service's technologies.",
		},
		{
			title:"Information You Provide",
			info:"The types of personal information that the Service collects directly from you may include:",
			list:[
			...
			info1:"In order to access certain content and to make use of additional functionality and features of the Service, we ask you to register for an account by completing and submitting a registration form, which may request additional information.",
			info2:"If you choose to register and sign in by using a third party account (such as your Facebook account), the authentication of your login is handled by the third party and the Service will collect your name, email address and any other information about your third-party account that you agree to share with us at the time you give permission for your account on the Service to be linked to your third party account."
		},
		{
			title:"Information Collected Automatically",
			info:"The Service also automatically collects, through our servers and the use of cookies (small text files sent to your computer), web beacons (also known as clear or single pixel .gifs) and other technologies, information that tells us how you use the Service, such as:",
			list:[
				...
				"Uniform Resource Locator ('URL') click stream data, including date and time stamp, referring and exit URLs, search terms you used, and pages you visited or searched for on the Service;",
			...
			info1:"We may use and disclose information that does not reveal your identity or permit direct association with any specific individual, such as browser and device information, anonymous usage data and aggregated information, for any purpose, except where we are restricted by law. If we combine non-personal information with personal information, the combined information will be treated as personal information for as long as it remains combined.",
			info2:"You can control cookies through your browser's settings and other tools. However, if you block certain cookies, you may not be able to register, login to the Service, access certain parts of the Service or make full use of the Service.",
		},
		{
			title:"Use of Your Information",
			info:"We may use your personal information to:",
			list:[
			...
			info1:"We may on occasion also match or combine the personal information that you provide with information that we obtain from other sources or that is already in our records, whether collected online or offline or by predecessor or affiliated group companies, for the purposes described above.",
		},
		{
			title:"Disclosure of Your Information",
			info:"We may share your personal information with:",
			list:[
			...
			info1:"to assist us with producing and delivering our products and services, developing and operating our businesses, systems and applications, processing payments, customer support, marketing, promotion and communications and for other purposes set forth in this privacy policy.",
			info2:"We also may share your personal information with our affiliated group companies worldwide and with societies, sponsors and other non-affiliated third parties that wish to send you information about their products and services that may be of interest to you as determined by your choices in managing your communications preferences following the process described below.",
			info3:"If the Service offers a content database or learning service ('Subscription Service') and you access the Subscription Service through an institution-sponsored subscription, your personal information and certain usage data gathered through the Subscription Service, such as the number of items you downloaded, any non-subscribed items you accessed, and test scores, may be shared with your institution for the purposes of usage analysis, subscription management, course management and testing and remediation. If your institution is a corporation or other business entity, additional usage data, such as the types of records you viewed and the number of searches you ran, also may be shared for the purposes of cost attribution and departmental budgeting.",
			info4:"We also may need to disclose your personal information:",
			list1:[
		...
		},
		{
			...
			info:"Your personal information may be transferred to other countries for processing. By using the Service you consent to the transfer of information to countries outside of your country of residence, which may have different personal data protection rules than in your country.",
		},
		{
			title:"Changes to Our Privacy Policy",
			info:"We may change this privacy policy from time to time. Any changes will be posted on this page with an updatedrevision date.",
		},
		{
			title:"Contact",
